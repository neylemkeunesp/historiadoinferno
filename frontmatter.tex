...
\vspace{2.0cm}
{\large Baseada em fontes acadêmicas especializadas\par}
\vfill
{\large Ney Lemke\par}
\vspace{1.5cm}
...
hierarquia original de 5 partes e 19 capítulos, além de 83 imagens
...
representações distópicas da era digital. Baseada em fontes
...
cada época conforme as ansiedades e os dilemas éticos de cada civilização.
