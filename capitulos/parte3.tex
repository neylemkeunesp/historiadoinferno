...
\begin{figure}[ht]
  ...
  \caption{Vista panorâmica do Vale de Hinnom (Geena), mostrando sua proximidade com a Cidade de Davi. O depósito de lixo em chamas que existia neste local forneceu a imagem do ``fogo que nunca se apaga'' que aparece nas descrições bíblicas da Geena.}
  \label{fig:cap9-img4}
\end{figure}
...
% (image43 removida: ícone genérico de São João Damasceno ('santo com livro')
%  não distingue Damasceno de outros teólogos bizantinos; redundante com
%  a descrição do parágrafo anterior. A figura iconográfica da theosis é
%  discutida no corpo do texto sem recurso visual.)
