...
Do Sheol como Simples Morada dos Mortos à Geena como Local de Punição

Sheol na Literatura Bíblica Inicial
...
\section*{Esta concepção inicial do Sheol apresenta características específicas}
\addcontentsline{toc}{section}{Esta concepção inicial do Sheol apresenta características específicas}
...
A Transformação durante o Exílio e o Período do Segundo Templo
...
\addcontentsline{toc}{section}{Geena: Do Vale Geográfico ao Símbolo de Punição}
...
Desenvolvimento do Conceito de Ressurreição e Julgamento

Origens da Crença na Ressurreição
...
Julgamento Póstumo na Literatura Apocalíptica Judaica
...
Literatura Apocalíptica Judaica e sua Visão do Inferno

1 Enoque e a Cartografia do Além
...
Os Manuscritos do Mar Morto e as Crenças Essênias
...
Variações nas Concepções Judaicas ao Longo da História

Diferenças entre Fariseus, Saduceus e Essênios
...
O Desenvolvimento do Gehinom na Literatura Rabínica
...
\begin{figure}[ht]
  ...
  \caption{Ilustração 8 do capítulo.}
  \label{fig:cap9-img8}
\end{figure}
...
As Parábolas de Jesus e o Inferno
...
A Emergência da Doutrina no Cristianismo Primitivo
...
\addcontentsline{toc}{section}{Visões Divergentes: Universalismo versus Inferno Eterno}
...
Santo Agostinho e a Consolidação da Doutrina
...
Representações Artísticas Primitivas
...
Mosaicos Bizantinos e o Juízo Final
...
Manuscritos Iluminados e a Propagação Visual
...
A Função Social e Teológica do Inferno Primitivo
...
Instrumento de Controle Social e Moral
...
Resposta às Heresias e Consolidação Doutrinária
...
Textos/Autores Representativos

30-90 d.C.

Referências simbólicas à Geena e ao fogo eterno

Evangelhos Sinóticos, Parábola do Rico e Lázaro

90-150 d.C.

Primeiras descrições detalhadas das punições infernais

Apocalipse de João, Apocalipse de Pedro

150-250 d.C.

Debate sobre a eternidade das punições

Tertuliano (a favor), Orígenes (contra)

250-400 d.C.

Sistematização da doutrina do inferno

Lactâncio, Efrém da Síria

400-550 d.C.

Consolidação da visão ocidental do inferno

Santo Agostinho, Papa Gregório Magno
...
\addcontentsline{toc}{section}{Tradição Siríaca: Teologia Poética e Misericórdia Divina}
...
Tradição Copta e suas Influências Egípcias
...
\begin{figure}[ht]
  ...
  \caption{São João Damasceno (676-749) - Ícone ortodoxo. Teólogo bizantino que desenvolveu sofisticadas sínteses sobre theosis (deificação) e escatologia, influen}
...
Preservação Monástica da Tradição
...
\begin{figure}[ht]
  \centering
  \includegraphics[width=0.85\linewidth]{image51.jpeg}
  \caption{Ilustração 12 do capítulo.}
  \label{fig:cap12-img12}
\end{figure}

Afresco da Anastasis (Descida de Cristo ao Hades) no Mosteiro de Chora, Constantinopla (c. 1315). Cristo desce ao Hades para libertar os justos, pisoteando as portas do inferno e resgatando Adão e Eva.
...
Ícones Ortodoxos Pós-Bizantinos do Juízo Final
...
\begin{figure}[ht]
  ...
  \caption{Ilustração 17 do capítulo.}
...
Os Desenvolvimentos Patrísticos Orientais: Uma Tradição Teológica Distintiva
...
Tradições Siríacas e a Teologia Poética de Efrém


\begin{figure}[ht]
  \centering
  \includegraphics[width=0.85\linewidth]{image57.jpeg}
  \caption{Ícone bizantino de Santo Efrém, o Sírio. Suas composições poéticas sobre o paraíso e o inferno influenciaram profundamente a espiritualidade cristã oriental, enfatizando a compaixão divina.}
  \label{fig:cap12-img19}
\end{figure}

Ícone bizantino de Santo Efrém, o Sírio. Suas composições poéticas sobre o paraíso e o inferno influenciaram profundamente a espiritualidade cristã oriental, enfatizando a compaixão divina.
...
A Tradição Copta e suas Influências Egípcias
...
\addcontentsline{toc}{section}{Teologia Bizantina: Sínteses Sofisticadas}
...
A Tradição Hesiquiasta e a Experiência Mística
...
Iconografia Oriental e Representação Escatológica
...
Impacto das Invasões Islâmicas
...
Representações do Inferno na Arte Patrística Oriental

Tradições Manuscritas e Apocalípticas

O Apocalipse Copto de Pedro


Manuscritos Síríacos


A Tradição Bizantina da Anastasis

O Harrowing of Hell nos Afrescos Bizantinos
...
Características da Representação Bizantina
...
Tradições Armênias e Manuscritos Iluminados
...
O Juízo Final na Iconografia Ortodoxa
...
\begin{figure}[ht]
  ...
  \caption{Ilustração 40 do capítulo.}
