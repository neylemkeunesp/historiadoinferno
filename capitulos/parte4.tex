...
\section{Escatologia Islâmica Normativa: Paraíso, Inferno, Julgamento e Ressurreição}
...
\begin{figure}[ht]
 ...
 \caption{Representação da Ascensão do Profeta (Mi‘rāj), mostrando Muhammad guiado pelo anjo Gabriel através dos sete céus, segundo a tradição hagiográfica islâmica.}
...
\begin{figure}[ht]
 ...
 \caption{Representação do Dia do Juízo Final (\emph{Yawm al-Qiyāmah}) segundo a tradição islâmica, com a abertura dos livros das obras, a pesagem das almas na balança (\emph{al-mīzān}) e a separação entre justos e pecadores.}
...
\begin{figure}[ht]
 ...
 \caption{Miniatura islâmica ilustrando a travessia da ponte \emph{as-\d{s}irā\d{t}}, fina como lâmina sobre o abismo do inferno, pela qual as almas são conduzidas ao seu destino eterno após o Juízo.}
...
\begin{figure}[ht]
 ...
 \caption{Representação dos portões do Inferno (\emph{Jahannam}) na escatologia islâmica, cada portão correspondendo a uma categoria específica de pecados e punições.}
...
\begin{figure}[ht]
 ...
 \caption{Cena escatológica islâmica mostrando o interrogatório da alma no estado intermediário (\emph{Barzakh}) pelos anjos Munkar e Nakīr, antes do Dia do Juízo.}
...
\section{Conexões e Diálogos com o Cristianismo Medieval}
...
\subsection{Literatura Visionária: do Mi‘raj Islâmico às Visões Medievais Cristãs}
...
\subsection{Misticismo Cristão e Parâmetros Sufis}
...
\subsection{Teologia Escolástica e Intercâmbio Filosófico-Cosmológico}
...
\begin{figure}[ht]
 ...
 \caption{Fólio do \emph{Liber Scalae Machometi} (Livro da Escada de Maomé), manuscrito latino medieval baseado na narrativa islâmica do Mi‘rāj que circulou na Europa e influenciou a literatura visionária cristã.}
...
\begin{figure}[ht]
 ...
 \caption{Ilustração do ``Conto de Bayad e Riyad'' (final século XIII), único manuscrito ilustrado conhecido que sobreviveu dos mais de 8 séculos de presença muçulmana na Espanha. Representa o ambiente cultural de Al-Andalus onde se desenvolveram intercâmbios intelectuais entre tradições islâmicas e cristãs, incluindo conceitos escatológicos e narrativas visionárias.}
 \label{fig:cap13-img9}
\end{figure}

\begin{figure}[ht]
 \centering
 \includegraphics[width=0.85\linewidth,height=0.75\textheight,keepaspectratio]{image75.png}
 \caption{Diagrama da cosmologia dos sete céus islâmicos, estrutura que serviu de referência para as viagens visionárias em ambas as tradições abraâmicas e influenciou a síntese dantesca.}
...
\begin{figure}[ht]
 ...
 \caption{Representação esquemática dos sete céus e dos portões do Inferno (\emph{Jahannam}) na escatologia islâmica, com a hierarquia de profetas, anjos e demônios distribuídos pelas regiões celestes e infernais.}
...
\begin{figure}[ht]
 ...
 \caption{Ilustração medieval do \emph{Mi‘rāj} evidenciando o contraste entre as delícias do Paraíso (\emph{Jannah}) e os tormentos do Inferno (\emph{Jahannam}) presenciados por Muhammad durante sua ascensão noturna.}
...
\begin{figure}[ht]
 ...
 \caption{Diagrama do sistema ptolemaico de esferas celestiais concêntricas, modelo cosmológico adotado tanto por astrônomos muçulmanos quanto por pensadores cristãos medievais. Esta estrutura de nove esferas (sete planetárias + estrelas fixas + Primum Mobile) forneceu o framework para as viagens visionárias em ambas as tradições, desde o Mi‘rāj até a jornada de Dante através do Paraíso.}
...
\begin{figure}[ht]
 ...
 \caption{Representação esquemática da cosmologia de Dante na Divina Comédia, mostrando os nove círculos do Inferno (embaixo), a montanha do Purgatório (centro) e as esferas celestiais do Paraíso (acima). Esta estrutura reflete a síntese dantesca entre a cosmologia aristotélica mediada pelos comentaristas árabes e a teologia cristã, possivelmente influenciada por elementos do Mi‘rāj islâmico.}
...
\index{Dante Alighieri}\index{Purgatório}
...
\begin{figure}[ht]
 ...
 \caption{Célebre fresco de Domenico di Michelino (1465) na Catedral de Florença mostrando Dante Alighieri diante de sua visão do além. À esquerda veem-se os círculos do Inferno, ao centro a montanha do Purgatório, e à direita as esferas celestiais do Paraíso --- estrutura cosmológica que ecoa elementos do Mi‘rāj islâmico.}
 \label{fig:cap14-img1}
\end{figure}

\section{Precedentes na Literatura Visionária Medieval}
...
\begin{figure}[ht]
 ...
 \caption{Iluminura de Simon Marmion (século XV) retratando Túndalo sofrendo o transe que precede sua viagem visionária ao além, conforme narrado na ``Visão de Túndalo'' (\emph{Visio Tnugdali}, 1149). Esta obra cristã apresenta paralelos estruturais notáveis com o Mi‘rāj islâmico.}
...
\section{A Sistematização Escolástica: Tomás de Aquino e a Teologia do Inferno}
...
\subsection{Contrapasso por Analogia (Similitude)}
...
\subsection{Contrapasso por Contraste (Oposição)}
...
\begingroup
  ...
  \begin{longtable}{|>{\raggedright\arraybackslash}p{1.35cm}|>{\raggedright\arraybackslash}p{1.55cm}|>{\raggedright\arraybackslash}p{1.9cm}|>{\raggedright\arraybackslash}p{3.1cm}|>{\raggedright\arraybackslash}p{1.25cm}|>{\raggedright\arraybackslash}p{3.5cm}|}
    \caption{Contrapasso na \emph{Divina Comédia} (\emph{Inferno}), com pecado, punição, tipo e simbolismo moral.}\label{tab:contrapasso}\\
    \hline
    \textbf{Círculo/\allowbreak Local} & \textbf{Pecado} & \textbf{Pecadores Notáveis} & \textbf{Punição (Contrapasso)} & \textbf{Tipo} & \textbf{Simbolismo} \\
    \hline
    ...
    \hline
    Círculo VII, Anel 3 & Violência contra Deus, natureza e arte & Blasfemos (Capaneu), sodomitas (Brunetto Latini), usurários & Deitados ou correndo sobre areia ardente sob chuva de fogo & Analogia/\allowbreak Contraste & Blasfemos deitados (desafiaram Deus diretamente), sodomitas correm (violaram natureza/reprodução), usurários sentados (violaram arte/trabalho) \\
    \hline
    Círculo VIII, Bolgia 1 & Sedução/\allowbreak Proxenetismo & Giasone (Jasão), Venedico Caccianemico & Caminham em filas opostas açoitados por demônios cornudos & Analogia & Manipularam outros para luxúria; agora conduzidos como gado por chicotes demoníacos \\
    \hline
    Círculo VIII, Bolgia 2 & Adulação/\allowbreak Bajulação & Taide (cortesã), Alessio Interminei & Submersos em excremento humano & Contraste & Palavras falsamente doces tornam-se imundície literal e repugnante \\
    \hline
    ...
    \hline
    Círculo VIII, Bolgia 4 & Adivinhação/\allowbreak Feitiçaria & Tirésias, Aronte, Manto, Miguel Escoto & Cabeças torcidas para trás, forçados a caminhar de costas, lágrimas escorrendo pelas nádegas & Analogia & Tentaram ver futuro; agora só veem passado (atrás); violaram ordem do conhecimento \\
    \hline
    ...
    \hline
    Centro - Lúcifer & Traição suprema a Deus & Lúcifer/\allowbreak Satanás/\allowbreak Dis & Congelado até cintura no centro de Cocito; três faces (paródia da Trindade); mastiga Judas, Brutus e Cassius; bate seis asas produzindo vento gelado & Contraste & Quis elevar-se; agora fixo no ponto mais baixo; suas asas (símbolos de liberdade angélica) produzem prisão gelada; chora de seis olhos mas lágrimas congelam \\
    \hline
  \end{longtable}
\endgroup
...
A arquitetura punitiva revela uma gradação que correlaciona gravidade moral e
restrição física:

\begin{itemize}
  \item \textbf{Círculos superiores (II--V):} movimento perpétuo e caótico,
  com luxuriosos arrastados por vendavais, gulosos sob tempestade, avaros e
  pródigos em colisão circular e iracundos em luta aquática;
  \item \textbf{Círculos intermediários (VI--VIII):} movimento restrito e
  tortura ativa, com heréticos aprisionados, violentos imersos em sangue ou
  transformados em árvores e fraudulentos açoitados, queimados ou mutilados;
  \item \textbf{Círculo inferior (IX):} imobilização progressiva no gelo.
\end{itemize}


\begin{itemize}
  \item \textbf{Caina:} condenados congelados até o pescoço;
  \item \textbf{Antenora:} rostos voltados para cima e lágrimas congeladas;
  \item \textbf{Tolomea:} condenados de costas, com viseiras de gelo;
  \item \textbf{Judeca:} condenados completamente submersos;
  \item \textbf{Centro:} Lúcifer eternamente fixo.
\end{itemize}
...
A jornada infernal apresenta uma inversão térmica significativa. Nos círculos
superiores e médios predomina o calor:

\begin{itemize}
  \item fogo para heréticos, violentos contra Deus e conselheiros fraudulentos;
  \item sangue fervente para os violentos;
  \item piche fervente para os corruptos;
  \item areia ardente para os blasfemos.
\end{itemize}

No círculo inferior, em contraste, predomina o frio absoluto do Cocito congelado.
...
\subsection{Metamorfose e Instabilidade Ontológica}

Punições envolvendo transformação corporal concentram-se estrategicamente:

\begin{itemize}
  \item \textbf{Suicidas:} transformados permanentemente em árvores;
  \item \textbf{Ladrões:} submetidos a metamorfoses contínuas com serpentes;
  \item \textbf{Falsários:} deformados por doenças que corrompem a aparência.
\end{itemize}
...
\subsection{Paródias Litúrgicas e Teológicas}
...
\subsection{Significado Teológico}
...
\begin{table}[ht]
  ...
  \small
  \renewcommand{\arraystretch}{1.3}
  \caption{Comparação das fontes de inspiração dantesca.}
  \label{tab:fontes-dantes}
  \begin{tabularx}{\textwidth}{|>{\raggedright\arraybackslash}p{4.5cm}|X|}
    \hline
    \textbf{Tradição} & \textbf{Características e contribuição} \\
    \hline
    ...
    \hline
    Síntese Dantesca & Combina rigor teológico escolástico, imaginação poética, precisão alegórica e dramatização narrativa, criando sistema ao mesmo tempo filosoficamente coerente e artisticamente memorável. \\
    \hline
  \end{tabularx}
\end{table}
...
\subsection{Como Teologia Dramatizada}
...
O sistema dantesco influenciou profundamente diferentes campos culturais:

\begin{itemize}
  \item \textbf{Teologia moral católica:} visualização concreta das consequências do pecado;
  \item \textbf{Arte ocidental:} iconografia infernal de Botticelli, Doré, Rodin e outros;
  \item \textbf{Literatura mundial:} arquétipo da jornada através da condenação;
  \item \textbf{Filosofia:} reflexão sobre liberdade, escolha e consequência;
  \item \textbf{Psicologia:} metáfora da autodestruição e dos “infernos internos”.
\end{itemize}
...
\section{Iconografia Gótica do Inferno: Controle Social e Pedagogia na Idade Média}
...
\subsection{O Inferno nos Tímpanos Góticos: Controle Moral e Social}
...
\subsection{Teologia Medieval e Doutrinas Escatológicas}
...
\subsection{Imagem, Ritual e Teatro: Experiência Religiosa Coletiva}
...
\subsection{Variações Regionais na Tradição Gótica}
...
\subsection{Iconografia Gótica e Representação Visual}
...
\subsection{Drama Medieval e Performance da Danação}
...
\section{Bibliografia Selecionada}
...
\section{Humanismo Renascentista e Reinterpretação da Escatologia}
...
\section{Martinho Lutero e a Redefinição da Escatologia Protestante}
...
\section{João Calvino e a Escatologia da Predestinação}
...
\section{O Concílio de Trento e a Resposta Católica}
...
\section{A Imprensa e a Popularização das Ideias Escatológicas}
...
\section{Estados Confessionais e Propaganda do Inferno}
...
\section{Revolução Científica e Questionamentos Cosmológicos}
...
\section{Descobrimentos Geográficos e Relativização Cultural da Escatologia}
...
\subsection*{Fontes consultadas para esta seção}
...
\section{Crítica Histórica e o Desmantelamento da Autoridade Religiosa Tradicional}

\subsection{A Emergência do Método Histórico-Crítico}
...
\subsection{Implicações para a Doutrina do Inferno}
...
\subsection{Consequências Epistemológicas}
...
\section{Racionalismo Filosófico e a Crítica Moral da Punição Eterna}

\subsection{O Deísmo e o Problema da Teodiceia}
...
\subsection{Kant e o Imperativo da Proporcionalidade}
...
\subsection{Reformas Jurídicas e Humanitarismo Penal}
...
\subsection{Secularização da Moralidade}
...
\section{Secularização Social e Transformações Socioeconômicas}

\subsection{O Processo de Secularização Cultural}
...
\subsection{Desafios Científicos às Concepções Cosmológicas Tradicionais}
...
\subsection{A Revolução Industrial e o “Inferno na Terra”}
...
\subsection{Crítica Social e Declínio das Explicações Teológicas Tradicionais}
...
\section{Perspectivas Religiosas Modernas e Legados Contemporâneos}

\subsection{O Surgimento da Religião Comparada}
...
\subsection{O Protestantismo Liberal e Teologias Alternativas}
...
\subsection{Doutrinas Escatológicas Alternativas}
...
\subsection{Síntese e Legado Contemporâneo}
