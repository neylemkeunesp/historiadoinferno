...
\begin{figure}[ht]
  ...
  \caption{Foto de uma escultura em forma de morcego (Camazotz), proveniente de Copán, Honduras. O morcego (``Killer Bat'') é associado aos Senhores de Xibalba e aos domínios da noite e da morte}
  \label{fig:cap6-img1}
\end{figure}
...
\section*{XIBALBA}
\addcontentsline{toc}{section}{XIBALBA}


\section*{MICTLAN}
\addcontentsline{toc}{section}{MICTLAN}

UKHU PACHA

Governantes:Hun-Camé,

Vucub-Camé (Senhores da  Morte)


\section*{Governantes: Mictlantecuhtli}
\addcontentsline{toc}{section}{Governantes: Mictlantecuhtli}

e Mictlancihuatl

Governante: SUPAY (divindade

ctônica)


\section*{Casas de Tormento}
\addcontentsline{toc}{section}{Casas de Tormento}
...
\end{itemize}
Submundo subterrâneo ligado

\begin{itemize}
  \item a cavernas
  \item minas e
  \item fontes naturais
\end{itemize}

\section*{Critério: provas rituaisconhecimento esotérico}
\addcontentsline{toc}{section}{Critério: provas rituaisconhecimento esotérico}


\section*{Critério: tipo de morte e}
\addcontentsline{toc}{section}{Critério: tipo de morte e}

preparação ritual


\section*{Critério: acesso universal}
\addcontentsline{toc}{section}{Critério: acesso universal}

(não moralista), ligado a


\section*{Destino: transcendência ou}
\addcontentsline{toc}{section}{Destino: transcendência ou}

dissolução; modelo dos

heróis gêmeos Hunahpú e

Ixbalanqué


\section*{Destino: repouso eterno após}
\addcontentsline{toc}{section}{Destino: repouso eterno após}

4 anos de travessia e

oferendas a Mictlantecuhtli

Destino: integração com os  ancestrais e forças da terra

A análise comparativa revela paralelos estruturais notáveis entre submundos americanos e tradições do Velho Mundo, sugerindo arquetipos universais na organização de conceitos escatológicos. Todos apresentam geografia estratificada, provas rituais, divindades governantes duais (masculina/feminina), e ênfase em preparação adequada para navegação pós-morte. Estas similaridades, desenvolvidas independentemente, sugerem constantes antropológicas profundas na conceptualização humana de destino pós-morte.
